package org.lcx.robotframework.eclipse.launcher;
/*******************************************************************************
...
public class EclipseMain {
	...
	protected void setSecurityPolicy(URL[] bootPath) {
		...
		if (eclipseSecurity != null) {
			...
			ProtectionDomain domain = EclipseMain.class.getProtectionDomain();
			CodeSource source = null;
			if (domain != null)
				source = EclipseMain.class.getProtectionDomain().getCodeSource();
	...
	protected URL[] getBootPath(String base) throws IOException {
		...
		if (base != null) {
			...
			if(debug)
				System.out.println("install location="+url);
	...
	public static void main(String[] args) {
		int result = 0;
		try {
			result = new EclipseMain().run(args);
		} catch (Throwable t) {
