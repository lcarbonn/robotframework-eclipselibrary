...
:: 
set eclipse_library_version=0.6
...
set CLASSPATH=C:\outils\jdk1.5.0_12\lib\tools.jar;C:\RobotFramework\TestEclipse\lib\eclipselibrary-%eclipse_library_version%-with-dependencies.jar
