@echo off
set JYTHONPATH=C:\RobotFramework\Python26\Lib\site-packages
...
%jython% -m robot.libdoc --version 0.19 org.lcx.robotframework.eclipse.EclipseLibrary %docpath%\EclipseLibrary.xml
